        ...
        <div class="programa-evento">
          ...
          <div id="seminario" class="info-curso ocultar clearfix">
            <div class="detalle-evento">
              ...
              <p><i class="fa fa-calendar" aria-hidden="true"></i> 23/05/22</p>
            ...
            <div class="detalle-evento">
              ...
              <p><i class="fa fa-calendar" aria-hidden="true"></i> 23/05/22</p>
              <p><i class="fa fa-user" aria-hidden="true"></i> Suana Rlivera</p>
            </div>
          ...
          <div id="talleres" class="info-curso ocultar clearfix">
            <div class="detalle-evento">
              ...
              <p><i class="fa fa-calendar" aria-hidden="true"></i> 23/05/22</p>
              <p><i class="fa fa-user" aria-hidden="true"></i> GaelGam3r67</p>
            </div>
            <div class="detalle-evento">
              <h3>Responsive Web Desing</h3>
              <p><i class="fa fa-clock-o" aria-hidden="true"></i> 20:00</p>
              <p><i class="fa fa-calendar" aria-hidden="true"></i> 23/05/22</p>
              <p><i class="fa fa-user" aria-hidden="true"></i> Chuy2502r</p>
            </div>
            <a href="calendario.html" class="button float-right">Ver todos</a>
          </div>
          <!--#talleres-->
    ...
    <!-- <div class="contenedor clearfix"> -->
      ...
      <!-- <div class="ultimos-tweets"> -->
        ...
        <!-- <a class="twitter-timeline" data-height="400" data-theme="light" data-link-color="#fe4918" -->
          <!-- href="https://twitter.com/JuanDevWP">Tweets by JuanDevWP</a> -->
